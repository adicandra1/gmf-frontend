    ...
    public function render(): string
    {
        ...
        <nav class="navbar top-navbar col-lg-12 col-12 p-0">
            ...
            <div class="navbar-menu-wrapper d-flex align-items-center justify-content-between">
                ...
                <a class="navbar-brand brand-logo" href="<?= route_to(RoutesConstant::DASHBOARD) ?>"><img src="<?= base_url() . PORTAL_ASSETS_RELATIVE_PATH. 'images/logo_gdps.svg' ?>" alt="logo" /></a>
                <a class="navbar-brand brand-logo-mini" href="<?= route_to(RoutesConstant::DASHBOARD) ?>"><img src="<?= base_url(ViewHelper::PORTAL_ASSETS_RELATIVE_PATH . 'images/logo_gdps.svg') ?>" alt="logo" /></a>
                </div>
                ...
                <li class="nav-item nav-profile dropdown">
                    ...
                    <a class="dropdown-item" href="<?= route_to(RoutesConstant::SETTINGS) ?>">
                        <i class="mdi mdi-settings text-primary"></i>
                        Settings
                    </a>
                    <a class="dropdown-item" href="<?= route_to(RoutesConstant::LOGOUT) ?>">
