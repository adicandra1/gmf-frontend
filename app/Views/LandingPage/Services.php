...
class Services extends AppShell
{
    function mainContent(): string
    {
        ...
        <section class="site-section pb-0">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 mb-5 mb-lg-0">
                        <img src="<?= base_url(ViewHelper::LANDINGPAGE_ASSETS_RELATIVE_PATH . 'images/azmi/1.jpeg') ?>" alt="Image" class="img-fluid img-shadow">
                        </a>
                    </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 mb-5 mb-lg-0 order-md-2">
                        <img src="<?= base_url(ViewHelper::LANDINGPAGE_ASSETS_RELATIVE_PATH . 'images/azmi/2.jpeg') ?>" alt="Image" class="img-fluid img-shadow">
                        </a>
                    </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 mb-5 mb-lg-0">
                        <img src="<?= base_url(ViewHelper::LANDINGPAGE_ASSETS_RELATIVE_PATH . 'images/azmi/3.jpeg') ?>" alt="Image" class="img-fluid img-shadow">
                        </a>
                    </div>
                    <div class="col-lg-5 ml-auto">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 mb-5 mb-lg-0 order-md-2">
                        <img src="<?= base_url(ViewHelper::LANDINGPAGE_ASSETS_RELATIVE_PATH . 'images/azmi/4.jpeg') ?>" alt="Image" class="img-fluid img-shadow">
                        </a>
                    </div>
                    <div class="col-lg-5 mr-auto order-md-1  mb-5 mb-lg-0">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 mb-5 mb-lg-0">
                        <img src="<?= base_url(ViewHelper::LANDINGPAGE_ASSETS_RELATIVE_PATH . 'images/azmi/5.jpeg') ?>" alt="Image" class="img-fluid img-shadow">
                        </a>
                    </div>
                    <div class="col-lg-5 ml-auto">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 mb-5 mb-lg-0 order-md-2">
                        <img src="<?= base_url(ViewHelper::LANDINGPAGE_ASSETS_RELATIVE_PATH . 'images/azmi/6.jpeg') ?>" alt="Image" class="img-fluid img-shadow">
                        </a>
                    </div>
                    <div class="col-lg-5 mr-auto order-md-1  mb-5 mb-lg-0">
        ...
        <section class="site-section pt-0">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 mb-5 mb-lg-0">
                        <img src="<?= base_url(ViewHelper::LANDINGPAGE_ASSETS_RELATIVE_PATH . 'images/azmi/7.jpeg') ?>" alt="Image" class="img-fluid img-shadow">
                        </a>
                    </div>
                    <div class="col-lg-5 ml-auto">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 mb-5 mb-lg-0 order-md-2">
                        <img src="<?= base_url(ViewHelper::LANDINGPAGE_ASSETS_RELATIVE_PATH . 'images/azmi/8.jpeg') ?>" alt="Image" class="img-fluid img-shadow">
                        </a>
                    </div>
                    <div class="col-lg-5 mr-auto order-md-1  mb-5 mb-lg-0">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 mb-5 mb-lg-0">
                        <img src="<?= base_url(ViewHelper::LANDINGPAGE_ASSETS_RELATIVE_PATH . 'images/azmi/9.jpeg') ?>" alt="Image" class="img-fluid img-shadow">
                        </a>
                    </div>
                    <div class="col-lg-5 ml-auto">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 mb-5 mb-lg-0 order-md-2">
                        <img src="<?= base_url(ViewHelper::LANDINGPAGE_ASSETS_RELATIVE_PATH . 'images/azmi/10.jpeg') ?>" alt="Image" class="img-fluid img-shadow">
                        </a>
                    </div>
                    <div class="col-lg-5 mr-auto order-md-1  mb-5 mb-lg-0">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 mb-5 mb-lg-0">
                        <img src="<?= base_url(ViewHelper::LANDINGPAGE_ASSETS_RELATIVE_PATH . 'images/azmi/13.jpeg') ?>" alt="Image" class="img-fluid img-shadow">
                        </a>
                    </div>
                    <div class="col-lg-5 ml-auto">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 mb-5 mb-lg-0 order-md-2">
                        <img src="<?= base_url(ViewHelper::LANDINGPAGE_ASSETS_RELATIVE_PATH . 'images/azmi/11.jpeg') ?>" alt="Image" class="img-fluid img-shadow">
                        </a>
                    </div>
                    <div class="col-lg-5 mr-auto order-md-1  mb-5 mb-lg-0">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 mb-5 mb-lg-0">
                        <img src="<?= base_url(ViewHelper::LANDINGPAGE_ASSETS_RELATIVE_PATH . 'images/azmi/12.jpeg') ?>" alt="Image" class="img-fluid img-shadow">
                        </a>
                    </div>
                    <div class="col-lg-5 ml-auto">
