...
<div class="site-wrap">
    ...
    <!-- HOME -->
    <section class="section-hero overlay inner-page bg-image" style="background-image: url('images/hero_1.jpg'); height: 50px;" id="home-section">
      <div class="container">
        <div class="row">
          <div class="col-md-7">
    ...
    <section class="mt-5" id="next-section">
      <div class="container">
        <div class="row">
            ...
            <div class="border p-4 rounded">
              <div class="row">
                ...
                <div style="padding-left: 10px;">
                  <h2 class="mb-4 mt-4">Graphic Design</h2>
