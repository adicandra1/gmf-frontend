	...
	<div class="col-lg-4 mb-3 mb-lg-0">
		<div class="card congratulation-bg text-center">
			<div class="card-body pb-0">
				<img src="<?= base_url() . PORTAL_ASSETS_RELATIVE_PATH . 'images/dashboard/face29.png' ?>" alt="">
						...
						<div class="row">
							...
							<div class="col-lg-4">
								<div class="position-relative">
									<img src="<?= base_url() . PORTAL_ASSETS_RELATIVE_PATH . 'images/dashboard/live.png' ?>" class="w-100" alt="">
...
<script src="<?= base_url() . PORTAL_ASSETS_RELATIVE_PATH . 'vendors/chart.js/Chart.min.js' ?>"></script>
<script src="<?= base_url() . PORTAL_ASSETS_RELATIVE_PATH . 'vendors/progressbar.js/progressbar.min.js' ?>"></script>
<script src="<?= base_url() . PORTAL_ASSETS_RELATIVE_PATH . 'vendors/chartjs-plugin-datalabels/chartjs-plugin-datalabels.js' ?>"></script>
<script src="<?= base_url() . PORTAL_ASSETS_RELATIVE_PATH . 'vendors/justgage/raphael-2.1.4.min.js' ?>"></script>
<script src="<?= base_url() . PORTAL_ASSETS_RELATIVE_PATH . 'vendors/justgage/justgage.js' ?>"></script>
<!-- Custom js for this page-->
<script src="<?= base_url() . PORTAL_ASSETS_RELATIVE_PATH . 'js/dashboard.js' ?>"></script>
